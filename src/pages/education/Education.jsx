...
const Education = () => {
  return (
    ...
    >
      <motion.h2
        className="text-4xl sm:text-5xl text-center font-extrabold mb-16 bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500 text-[#9FA1FF]"
      ...
      <div className="flex justify-center">
        {educationData.map((edu, index) => (
          <Tilt
            ...
            tiltMaxAngleY={10}
            transitionSpeed={400}
            className="w-full sm:w-[90%] md:w-[70%] lg:w-[60%] bg-[#15152b] rounded-2xl border border-[#9FA1FF60] shadow-lg hover:shadow-[0_0_20px_#9FA1FFaa] transition duration-500 p-6 sm:p-8"
          >
            <motion.div
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <FaGraduationCap className="text-[#9FA1FF] text-2xl sm:text-3xl" />
                <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-white">
                  {edu.degree}
                </h3>
              </div>
              <p className="text-[#9FA1FF] font-medium text-sm sm:text-base">
                {edu.College}
              </p>
              <p className="text-[#9FA1FF] font-medium text-sm sm:text-base">
                {edu.institution}
